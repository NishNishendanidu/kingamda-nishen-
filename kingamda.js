...
let DataPack = require('king-amda-pro/export/output');

let SewQueen = require('King-amda-pro/sources/dc/handler');

let Details = require('King-amdapro/sources/dc/Details');

let GBLACK =require('blocked-s/grp')

let SOL =require('KING-AMDA-pro/console')

let {CheckUpdatesWeb, sendMessageownerMSG, sendMessageADSMSG, sendMessageBotOn, sendMessageGreetingMSG, sendMessageMSGMSG, sendMessageBlackListMSG, sendMessageBIOMSG} = require('Kingamda-pro/sources/dc/king')
...
let {WAConnection, MessageOptions, MessageType, Mimetype, Presence} = require('@ninishendanidu/kingamda-x-web');  

let {Message, StringSession, Image, Video} =  require('king- amda- pro/sources/dc/Wa-Base/');
...
async function kingAmda() {
        ...
        } else { console.log('Need KING_AMDA_SESSION \n'.repeat(50));return;}
